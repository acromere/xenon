...
com.acromere.xenon.mod parent pom. The parent pom will ensure that the module is 
packaged properly for ${project.name}:

~~~~
<parent>
	<groupId>com.acromere.pom</groupId>
...
The implementing class must extend com.acromere.xenon.Mod. It must also have
